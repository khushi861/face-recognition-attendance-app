...
const Teacherlogin = (props) => {
  ...
  const onSubmit = ()=>{
    ...
    else if (email=== "teacher123@gmail.com"){
      Alert.alert("Logged in successfully")
      setEmail("")
      setPassword("")
          setTimeout(()=>{props.navigation.navigate("Teacherdashboard")},1000)
    }
  }
  ...
  return (
    <View style={styles.login_Body} >
      <View style={styles.login_Header}>
        ...
        <View><Text style={styles.title_Text}>Teacher Login</Text></View>
      ...
      <View style={styles.inputContainer}>
          ...
          <TextInput
           ...
           />
           <Icon size={30} name="lock" color="black" style={styles.inputIcon}/>
        </View>
        <TouchableOpacity 
        style={styles.button}
        onPress={onSubmit}
